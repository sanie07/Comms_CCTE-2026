/**
 * @file    aprs_config.h
 * @brief   Hardcoded APRS tracker configuration for Test10.
 */
...
/* Fixed fallback position (used when no coords received from ESP32). */
#define APRS_LATITUDE       "0000.00N"
#define APRS_LONGITUDE      "00000.00E"
#define APRS_SYMBOL_TABLE   '/'
#define APRS_SYMBOL_CODE    '-'
#define APRS_BEACON_MSG     "TEST10"
#define APRS_FIXED_INFO     "!0000.00N/00000.00E-TEST10"
#define APRS_BEACON_INTERVAL_MS  15000UL
