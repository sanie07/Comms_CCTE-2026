...
def do_merge(args):
    ...
    #merge the three or four elements and pad in between , add some extra byte to
...
def do_append(args):
    ...
    #Add header + user application to the existing binary and pad in between
